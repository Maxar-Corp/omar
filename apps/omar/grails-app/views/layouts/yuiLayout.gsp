...
<body class="yui-skin-sam" onload="bodyOnResize();${pageProperty(name: 'body.onload')}" onresize="bodyOnResize();${pageProperty(name: 'body.onresize')}">
	...
	<g:javascript>
		...
		var bodyOnResize = function() {
			...
			var mapWidth = middle1.offsetWidth - (left1.offsetWidth + right1.offsetWidth) + "px";
			var mapHeight = middle1.offsetHeight - 7 - (top1.offsetHeight + bottom1.offsetHeight + top2.offsetHeight + bottom2.offsetHeight) + "px";
