    ...
    <div class="niceBoxBody">
      <ol>
        ...
        <li><g:textField name="ddMapCtr" id="ddMapCtr" value="" onChange="setMapCtr('dd', this.value)" size="28"
            title="Enter decimal degree coordinates and click off the text field to re-center the map. Example: 25.77, -80.18" style = "background:  black; color: white"/></li>
      </ol>
      <ol>
        <li style = "color: #00ccff">DMS:</li>
        <li><g:textField name="dmsMapCtr" id="dmsMapCtr" value="" onChange="setMapCtr('dms', this.value)" size="28"
            title="Enter degree minute seconds coordinates and click off the text field to re-center the map. Example: 25Â°46'20.66'' N, 80Â°11'23.64'' W" style = "background:  black; color: white"/></li>
      </ol>
      <ol>
        ...
        <li><g:textField name="centerMgrs" id="centerMgrs" value="" onChange="setMapCtr('mgrs', this.value)" size="28"
            title="Enter mgrs coordinate and click off the text field to re-center the map. Example: 17RNJ8123050729 or 17 RNJ 81230 50729" style = "background:  black; color: white"/></li>
      </ol>
      <div align="center">
    ...
    <div class="niceBoxBody">
      <ul>
        ...
        <li><g:select name="measurementUnits" from="${['kilometers', 'meters', 'feet', 'miles', 'yards']}"
            title="Select a unit of measuremen and use the path and polygon measurment tools in the map toolbar." onChange="measureUnitChanged(this.value)" style = "background:  black; color: white"/></li>
