...
function OmarParams()
{
    ...
    {
        result = ""
        if ( !includeNullPropertiesFlag )
        {
            includeNullPropertiesFlag = false
        }
...
function OmarMatrix3x3()
{
    ...
    this.create = function ( v00, v01, v02, v10, v11, v12, v20, v21, v22 )
    {
    ...
    this.assign = function ( v00, v01, v02, v10, v11, v12, v20, v21, v22 )
    {
        this.m00 = v00;
        this.m01 = v01;
        this.m02 = v02;
...
function OmarAffineImageModel()
{
    ...
    this.viewBounds = function ()
    {
        ...
        {
            if ( corners[idx].x < minx )
            {
                minx = corners[idx].x;
            }
            if ( corners[idx].x > maxx )
            {
                maxx = corners[idx].x;
            }
            if ( corners[idx].y < miny )
            {
                miny = corners[idx].y;
            }
            if ( corners[idx].y > maxy )
            {
                maxy = corners[idx].y;
            }
        }
