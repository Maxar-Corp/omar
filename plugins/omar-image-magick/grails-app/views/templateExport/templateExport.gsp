...
<content tag="center">
    ...
    <img id="overviewMapImage" onClick="changeOverviewMap()" onLoad="positionOverviewMapImage();
    positionNorthArrow()"/>
    ...
    <div id="loadingDialog" title="Generating Template...">
        ...
        <div align="center" id="spinner" valign="bottom"></div>
    </div>
    ...
    <div id="downloadDialog"
         title="Downloading...">The download will start automatically once the template is complete.</div>
