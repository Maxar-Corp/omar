...
<head>
  ...
  <meta name="layout" content="searchStaticNew"/>
  ...
  <div class="niceBox">
    ...
    <div class="niceBoxBody">
      <ol>
        ...
        <li>
          <omar:dateChooser name="startDate" format="MM/dd/yyyy" timezone="${TimeZone.getTimeZone('UTC')}" style="width:75px" time="true" hourStyle="width:25px" minuteStyle="width:25px" value="${queryParams.startDate}" onChange="updateOmarFilters()" inputId="startDateInput" containerId="startDateContainer" render="input"/>
        ...
        <li>
          <omar:dateChooser name="endDate" format="MM/dd/yyyy" timezone="${TimeZone.getTimeZone('UTC')}" style="width:75px" time="true" hourStyle="width:25px" minuteStyle="width:25px" value="${queryParams.endDate}" onChange="updateOmarFilters()" inputId="endDateInput" containerId="endDateContainer" render="input"/>
...
<omar:dateChooser name="startDate" format="MM/dd/yyyy" timezone="${TimeZone.getTimeZone('UTC')}" style="width:75px" time="true" hourStyle="width:25px" minuteStyle="width:25px" value="${queryParams.startDate}" onChange="updateOmarFilters()" inputId="startDateInput" containerId="startDateContainer" render="script"/>
<omar:dateChooser name="endDate" format="MM/dd/yyyy" timezone="${TimeZone.getTimeZone('UTC')}" style="width:75px" time="true" hourStyle="width:25px" minuteStyle="width:25px" value="${queryParams.startDate}" onChange="updateOmarFilters()" inputId="endDateInput" containerId="endDateContainer" render="script"/>
