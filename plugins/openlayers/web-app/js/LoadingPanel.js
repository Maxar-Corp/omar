...
OpenLayers.Control.LoadingPanel = OpenLayers.Class(OpenLayers.Control, {
    ...
    */
    increaseCounter: function() {
        ...
        var region = YAHOO.util.Region.getRegion(this.map.viewPortDiv);
        //this.div.style.lineHeight = region.height/2+"px";
        //var region = YAHOO.util.Region.getRegion(this.div);
        //this.div.style.lineHeight = region.height*0.4 +"px";
        //this.div.innerHTML=this.message;
