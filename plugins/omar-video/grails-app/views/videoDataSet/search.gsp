          ...
          <div class="niceBox">
            ...
            <div class="niceBoxBody">
              <ol>
                ...
                <li>
                  <g:textField title="Specify the radial search in meters" id="aoiRadius1" name="aoiRadius" value="${fieldValue(bean: queryParams, field: 'aoiRadius')}" onChange="updateOmarFilters();syncAoiRadius('aoiRadius1')"/>
                </li>
                <li>
                  <br/>
                </li>
          ...
          <div class="niceBox">
            ...
            <div class="niceBoxBody">
              ...
              <ol>
                ...
                <li>
                  <input title="Specify the eastern longitude in decimal degrees" type="text" id="aoiMaxLon" name="aoiMaxLon" value="${fieldValue(bean: queryParams, field: 'aoiMaxLon')}"/>
                </li>
                <li>
                  <br/>
                </li>
          ...
          <div class="niceBox">
            ...
            <div class="niceBoxBody">
              <ol>
                ...
                <li>
                    <g:textField title="Specify the radial search in meters" id="aoiRadius2" name="aoiRadius" value="${fieldValue(bean: queryParams, field: 'aoiRadius')}" onChange="updateOmarFilters();syncAoiRadius('aoiRadius2')"/>
                </li>
                <li>
                  <br/>
                </li>
          ...
          <div class="niceBox">
            ...
            <div class="niceBoxBody">
              <ol>
                ...
                <li>
                  <input title="Enter a dms of the form dddmmss.ssssE|W or ddd mm ss.sss E|W" type="text" id="aoiMinLonDms" name="aoiMinLonDms"/>
                </li>
                <li>
                  <label for="aoiMinLat">South Latitude:</label>
                </li>
                ...
                <li>
                    <button title="Clear the Bounding Box search options"  type="button"  onclick="javascript:mapWidget.clearAOI()">Clear AOI</button>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="niceBox">
            ...
            <div class="niceBoxBody">
              <ol>
                ...
                <li>
                    <g:textField title="Specify the radial search in meters" id="aoiRadius3" name="aoiRadius" value="${fieldValue(bean: queryParams, field: 'aoiRadius')}" onChange="updateOmarFilters();syncAoiRadius('aoiRadius3')"/>
                </li>
                <li>
                  <br/>
                </li>
