...
<g:form name="searchForm">
  ...
  <content tag="left">
    ...
    <div align="center">
      <span id="linkbutton1" class="yui-button yui-link-button" title="Search Video"><span class="first-child"><a
          href="javascript:search();">Search Video</a></span></span>
    </div>
  </content>
    ...
    <table>
      <tr>
        <td colspan=3 id="top2"><div id="toolBar" class="olControlPanel"></div><span id="linkbutton2"
                                                                                     ...
                                                                                     title="Search Video"><span
              class="first-child"><a href="javascript:search();">Search Video</a></span></span></td>
      </tr>
      <tr>
