...
<content tag="top">
  ...
  <script type="text/javascript">
    YAHOO.example.init = function () {
      ...
      var oLinkButton4 = new YAHOO.widget.Button({ type: "link", id: "linkbutton6", label: "Search Videos", href: "javascript:mapWidget.search();", container: "linkbuttonsfromjavascript" });
    } ();
  </script>
