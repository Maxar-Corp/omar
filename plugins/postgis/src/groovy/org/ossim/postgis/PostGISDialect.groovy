...
/*
 * org.ossim.postgis.PostGISDialect.java
 * 
 ...
 * http://www.gnu.org.
 * 
 * $Id: org.ossim.postgis.PostGISDialect.java 2531 2006-11-22 10:42:17Z mschaber $
 */
...
public class PostGISDialect extends PostgreSQLDialect
{
  ...
  public PostGISDialect()
  {
    ...
    registerFunction(PostGISDialect.NAMESPACE + "geomfromewtk", new StandardSQLFunction("ST_GeomFromEWKT", Hibernate.custom(GeometryType.class)));

    registerFunction(PostGISDialect.NAMESPACE + "box3d", new StandardSQLFunction("box3d", Hibernate.custom(GeometryType.class)));
    registerFunction(PostGISDialect.NAMESPACE + "xmin", new StandardSQLFunction("xmin", Hibernate.DOUBLE));
    registerFunction(PostGISDialect.NAMESPACE + "ymin", new StandardSQLFunction("ymin", Hibernate.DOUBLE));
    registerFunction(PostGISDialect.NAMESPACE + "xmax", new StandardSQLFunction("xmax", Hibernate.DOUBLE));
    registerFunction(PostGISDialect.NAMESPACE + "ymax", new StandardSQLFunction("ymax", Hibernate.DOUBLE));
