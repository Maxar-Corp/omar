<p>Display Unit: <g:select name="displayUnit" from="${['DD', 'DMS', 'MGRS']}" title="Select decimal degrees, degrees minutes seconds, or military grid reference system for coordinate readouts." onChange="omar.setMapCenterTextField();omar.setBoundBoxTextField();" /></p>
	   ...
	   <label>Use Map Bounds</label>
		<div id="tabview1" class="yui-navset">
			...
			<div class="yui-content">
				<div id="tab1">
					<p><b>Map Center:</b></p>
					<p><g:textField name="point" onChange="omar.setMapCenter()" title="Enter map center coordinates in decimal degrees, degrees minutes seconds, or military grid reference system." /></p>
					<p><b>Radius in Meters:</b></p>
					<p><g:textField name="radius" title="Enter aoi radius in meters." /></p>
					
					<p>&nbsp;</p>
					
					<p><span id="linkbutton1" class="yui-button yui-link-button" title="Click to set map center."><span class="first-child"><a href="javascript:omar.setMapCenter();">Set Map Center</a></span></span></p>
				</div>
				<div id="tab2">
					<p><b>Lower Left:</b></p>
					<p><g:textField name="lowerLeft" title="Enter lower left bound box coordinates in decimal degrees, degrees minutes seconds, or military grid reference system." /></p>
					<p><b>Upper Right:</b></p>
					<p><g:textField name="upperRight" title="Enter upper right bound box coordinates in decimal degrees, degrees minutes seconds, or military grid reference system." /></p>
					
					<p>&nbsp;</p>
					
					<p><span id="linkbutton2" class="yui-button yui-link-button" title="Click to clear bound box."><span class="first-child"><a href="javascript:omar.clearBoundBox();">Clear Bound Box</a></span></span></p>
				</div>
			</div>
		</div>
	</div>
