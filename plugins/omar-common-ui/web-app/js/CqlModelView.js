                ...
                else
                {
                    ...
                    case "geometry":
                        ...
                        case "bbox":
                            ...
                            if ( !OMAR.isFloat( minLon ) || !OMAR.isFloat( minLat ) || !OMAR.isFloat( maxLon ) || !OMAR.isFloat( maxLat ) )
                            {
                        ...
                        case "dwithin":
                            ...
                            // until geotools fixes support for unit conversion they use the units of the
                    ...
                    case "string":
                        ...
                        if ( expr.colval === "be_number" && OMAR.beSearchParams.tableName)
                        {

                            var foo = fullExpression.replace( 'be_number', OMAR.beSearchParams.columnName );

                            foo = foo.split( "'" ).join( "''" )
                            fullExpression = "(" + fullExpression + " or intersects(ground_geom, collectGeometries(queryCollection('" + OMAR.beSearchParams.tableName + "', '" + OMAR.beSearchParams.geomName + "', '" + foo + "'))))";
